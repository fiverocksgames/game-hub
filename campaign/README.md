...
This directory contains campaign planning and production documents for Game Hub promotion.

## Current campaign

- Google Ads brand video campaign
...
- `CAMPAIGN.md` — canonical campaign brief, objective, messaging, evidence rules, and current decisions
- `01-game-analysis.md` — factual gameplay analysis based on development repositories
- `02-synopsis-and-storyboard.md` — campaign synopsis and 30-second storyboard
...
Repository-wide working rules are defined in `../AGENTS.md`.
